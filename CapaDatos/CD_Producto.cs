    ...
    public class CD_Producto
    {
        ...
        public int Registrar(Producto obj, out string Mensaje)
        {
            ...
            try
            {
                using (NpgsqlConnection conexion = new NpgsqlConnection(Conexion.cadena))
                {
                    NpgsqlCommand cmd = new NpgsqlCommand("sp_RegistrarProducto", conexion);
        ...
        public bool Editar(Producto obj, out string Mensaje)
        {
            ...
            try
            {
                using (NpgsqlConnection conexion = new NpgsqlConnection(Conexion.cadena))
                {
                    NpgsqlCommand cmd = new NpgsqlCommand("sp_ModificarProducto", conexion);
        ...
        public bool Eliminar(Producto obj, out string Mensaje)
        {
            ...
            try
            {
                using (NpgsqlConnection conexion = new NpgsqlConnection(Conexion.cadena))
                {
                    NpgsqlCommand cmd = new NpgsqlCommand("SP_EliminarProducto", conexion);
                    cmd.Parameters.AddWithValue("IdProducto", obj.IdProducto);
                    cmd.Parameters.Add("Respuesta", NpgsqlTypes.NpgsqlDbType.Boolean).Direction = ParameterDirection.Output;
                    cmd.Parameters.Add("Mensaje", NpgsqlTypes.NpgsqlDbType.Varchar, 500).Direction = ParameterDirection.Output;
                    cmd.CommandType = CommandType.StoredProcedure;
