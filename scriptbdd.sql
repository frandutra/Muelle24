...
BEGIN
    ...
    -- Retorna los valores en un tipo de registro
...
DECLARE
    resultado record;
BEGIN
    resultado := SP_REGISTRARUSUARIO('123456789', 'Usuario de Prueba', 'usuario@example.com', 'contraseña', 1, true);
...
VALUES ('123456','ADMINISTRADOR','fdutra@GMAIL.COM','123456',7);
...
WHERE n.nspname = 'public' -- Cambia 'public' por el esquema deseado
      AND p.proname ILIKE 'sp%';
